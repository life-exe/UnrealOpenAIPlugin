...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnCancelBatch, const FCancelBatchResponse&, Response, const FOpenAIError&, RawError);
...
private:
    ...
    void OnCancelBatchCompleted(const FCancelBatchResponse& Response);
