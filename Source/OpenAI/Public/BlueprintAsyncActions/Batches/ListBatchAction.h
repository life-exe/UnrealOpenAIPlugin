...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnListBatch, const FListBatchResponse&, Response, const FOpenAIError&, RawError);
...
private:
    ...
    void OnListBatchCompleted(const FListBatchResponse& Response);
