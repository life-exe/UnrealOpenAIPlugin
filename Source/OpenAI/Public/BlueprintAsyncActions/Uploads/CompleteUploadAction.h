...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnCompleteUpload, const FUploadObjectResponse&, Response, const FOpenAIError&, RawError);
...
private:
    ...
    void OnCompleteUploadCompleted(const FUploadObjectResponse& Response);
